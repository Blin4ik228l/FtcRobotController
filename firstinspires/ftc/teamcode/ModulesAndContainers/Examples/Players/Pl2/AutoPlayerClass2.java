...
public class AutoPlayerClass2 extends PlayerClass{
    ...
    private PositionController.VyrState vyrState;
    private Odometry.MoveState moveState;
    private Odometry.RotateState rotateState;
    ...
    public void setFields(PositionController positionController){
...
//        this.rotateState = positionRobotController.getOdometryClass().rotateState;
        this.range = positionController.getRange();
    }
