...
public class DrivetrainMotors extends ExecutableCollector {
    ...
    public DrivetrainMotors() {
        ...
        encoderClass = new EncoderClass2(motorsCollector);
        sayCreated();
    }
    ...
    public class EncoderClass2 extends UpdatableCollector {
        ...
        public EncoderClass2(MotorWrapper.InnerCollector motors) {
