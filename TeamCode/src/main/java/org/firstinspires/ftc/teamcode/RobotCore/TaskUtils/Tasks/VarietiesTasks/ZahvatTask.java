...
public class ZahvatTask extends OrdinaryTask {
    public ZahvatTask(ZahvatHandler zahvatHandler, StandartArgs.zahvatStandartArgs args,OrdinaryTask.taskStartMode startMode) {
        super(zahvatHandler, args, startMode);
        this.zahvatHandler = zahvatHandler;
        this.args = args;
    }
    public ZahvatHandler zahvatHandler;
    public StandartArgs.zahvatStandartArgs args;
}
