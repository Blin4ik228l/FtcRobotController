...
public class TeleskopeTask extends OrdinaryTask {
    public TeleskopeTask(TeleskopeHandler teleskopeHandler, StandartArgs.teleskopeStandartArgs args, OrdinaryTask.taskStartMode startMode) {
        super(teleskopeHandler, args,  startMode);
        this.teleskopeHandler = teleskopeHandler;
        this.args = args;
    }
    public TeleskopeHandler teleskopeHandler;
    public StandartArgs.teleskopeStandartArgs args;
}
