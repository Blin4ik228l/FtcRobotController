...
public class MainSystem extends ExecutableModule {
    ...
    public MainSystem(SemiAutoPlayerClass1 semiAutoPlayerClass1, AutoPlayerClass2 autoPlayerClass2, OpMode op){
        ...
        PositionController.AutoState autoState = null;
        PositionController.GeneralState generalState2 = null;
    }
    ...
    public PositionController.AutoState autoState;
    public PositionController.GeneralState generalState2;
    @Override
    public void execute() {
...
//                        if (semiAutoPlayerClass1.drivetrain.positionRobotController.shootedArtifacts % 3 == 0 && semiAutoPlayerClass1.drivetrain.positionRobotController.shootedArtifacts != 3){
//                            semiAutoPlayerClass1.drivetrain.positionRobotController.generalState = PositionRobotController.GeneralState.Get_pos;
//                            semiAutoPlayerClass1.drivetrain.positionRobotController.autoState = PositionRobotController.AutoState.GO_AFORE_ARTIFACTS;
//                        }else {
//                            semiAutoPlayerClass1.drivetrain.positionRobotController.generalState = PositionRobotController.GeneralState.Get_pos;
...
//        }
    ...
    public void showData() {
        ...
        telemetry.addData("GeneralState", semiAutoPlayerClass1.drivetrain.positionController.generalState.toString());
        telemetry.addData("AutoState", semiAutoPlayerClass1.drivetrain.positionController.autoState.toString());
        telemetry.addLine();
