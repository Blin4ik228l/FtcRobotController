...
public class AutoRedNear extends LinearOpModeModernized {
    ...
    public void runOpMode() throws InterruptedException {
        robot = new RobotClass(GeneralInformation.ProgramName.Auto, GeneralInformation.Color.Red, GeneralInformation.StartPos.Near_wall,this);
        robot.setGeneralInformation(GeneralInformation.ProgramName.Auto, GeneralInformation.Color.Red, GeneralInformation.StartPos.Near_wall, this);
        run();
    }
}
