...
public class AutoBlueLeft extends LinearOpMode {
    Robot robot;
    Position pos1 = new Position(130, 0 , Math.toRadians(-90));
    Position pos2 = new Position( 130, -40, Math.toRadians(-90));
    Position pos3 = new Position( 130, 0, Math.toRadians(-90));
