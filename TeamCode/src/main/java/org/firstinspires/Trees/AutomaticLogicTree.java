package org.firstinspires.Trees;
...
public class AutomaticLogicTree extends ExecutableModule {
    ...
    private void loadProgram(){
        Task second = new Task(100, 0.5, hoodedShoter, telemetry, 2);

        Task third = new Task("hook", 0.5, hoodedShoter, telemetry, 3);
        Task fourth = new Task("flip", 0.5, hoodedShoter, telemetry, 3);
        Task fifth = new Task("horizontal", 0.5, hoodedShoter, telemetry, 4);
