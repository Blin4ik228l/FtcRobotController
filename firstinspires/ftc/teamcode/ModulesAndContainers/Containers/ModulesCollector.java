...
public class ModulesCollector{
    ...
    public ModulesCollector(GeneralInformation generalInformation, OpMode op) {
        ...
        semiAutoPlayerClass1 = new SemiAutoPlayerClass1(generalInformation, robot.getDrivetrain(), op);
        autoPlayerClass2 = new AutoPlayerClass2(generalInformation, robot.getCollector(), op);

        fileSystem = new FileSystem(op);

        modules = new Module[]{
                robot, semiAutoPlayerClass1, autoPlayerClass2, mainSystem, fileSystem
        };
