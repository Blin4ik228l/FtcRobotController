...
public class AutoRedFar extends LinearOpModeModernized {
    ...
    public void runOpMode() throws InterruptedException {
        robot = new RobotClass(GeneralInformation.ProgramName.Auto, GeneralInformation.Color.Red, GeneralInformation.StartPos.Far_from_wall,this);
        robot.setGeneralInformation(GeneralInformation.ProgramName.Auto, GeneralInformation.Color.Red, GeneralInformation.StartPos.Far_from_wall, this);
        run();
    }
}
